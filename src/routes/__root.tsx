...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pay 0.1 GEN. AI generates your unique fortune onchain. Powered by GenLayer x Base!" },
      { name: "author", content: "Zaksans" },
      { property: "og:title", content: "GenFortune - AI Fortune Cookies on GenLayer" },
      { property: "og:description", content: "Pay 0.1 GEN. AI generates your unique fortune onchain. Powered by GenLayer x Base!" },
      ...
      { name: "twitter:description", content: "Pay 0.1 GEN. AI generates your unique fortune onchain. Powered by GenLayer x Base!" },
