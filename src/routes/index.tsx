...
function CookieVisual({ phase }: { phase: Phase }) {
  ...
  return (
    <div className={phase === "cracking" ? "cookie-cracking" : "cookie-breathe"}>
      ...
      <img src={silverCookieImg} alt="Fortune cookie" width={312} height={312} className="cookie-img" style={{ position: "relative", zIndex: 1, background: "transparent", pointerEvents: "none" }} />
